...
Module PTree <: TREE.
  ...
  - assert (NOTIN1: ~ In (prev i) (xkeys m1 (xO i))).
    ...
    { intros. exploit in_xkeys. eexact H. intros (j1 & EQ1). 
      exploit in_xkeys; eauto. intros (j2 & EQ2). 
...
Remark H_rec':
  ...
  P' l a ->
  P' (l ++ (k, v) :: nil) (f a k v).
Proof using f' H_rec P_compat init. 
  unfold P'; intros.  
  set (m0 := T.remove k m). 
...
Proof using H_rec P_compat init. 
...
Proof using P' f' H_rec H_base P_compat. 
